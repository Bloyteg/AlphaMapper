...
using SharpDX;
using Color = Bloyteg.AW.Model.RWX.Data.Components.Color;
using Vector2 = SharpDX.Vector2;
using Vector3 = SharpDX.Vector3;

namespace AlphaMapper.Renderer.Utility
{
    public static class HelperExtensions
    {
        public static Vector3 ToDXVector3(this Bloyteg.AW.Math.Vector3 vector)
        {
            if (vector == null)
            {
                return Vector3.Zero;
        ...
        public static Vector2 ToDXVector2(this Bloyteg.AW.Math.Vector2 vector)
        {
            if (vector == null)
            {
                return Vector2.Zero;
